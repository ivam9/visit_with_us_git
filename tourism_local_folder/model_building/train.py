...
# =========================
Xtrain = pd.read_csv("hf://datasets/mayurdotcreate/tourism/Xtrain.csv")
Xtest = pd.read_csv("hf://datasets/mayurdotcreate/tourism/Xtest.csv")
ytrain = pd.read_csv("hf://datasets/mayurdotcreate/tourism/ytrain.csv")
ytest = pd.read_csv("hf://datasets/mayurdotcreate/tourism/ytest.csv")
...
with mlflow.start_run():
    ...
    repo_id = "mayurdotcreate/tourism-model"
